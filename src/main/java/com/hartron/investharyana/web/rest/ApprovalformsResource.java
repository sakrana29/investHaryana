...
public class ApprovalformsResource {
    ...
    @Timed
    public ResponseEntity<ApprovalformsDTO> createApprovalforms(@RequestBody ApprovalformsDTO approvalformsDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<ApprovalformsDTO> updateApprovalforms(@RequestBody ApprovalformsDTO approvalformsDTO) throws URISyntaxException {
