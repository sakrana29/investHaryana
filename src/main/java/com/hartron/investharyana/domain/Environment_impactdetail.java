...
public class Environment_impactdetail implements Serializable {
    ...
    @Column(name = "document_attached_content_type")
    ...
    public Environment_impactdetail document_attached(ByteBuffer document_attached) {
    ...
    public Environment_impactdetail document_attachedContentType(String document_attachedContentType) {
    ...
    public String toString() {
        return "Environment_impactdetail{" +
            ...
            ", document_attachedContentType='" + document_attachedContentType + "'" +
