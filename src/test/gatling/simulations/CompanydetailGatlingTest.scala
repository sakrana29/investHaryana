...
/**
 * Performance test for the Companydetail entity.
 */
class CompanydetailGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Companydetail entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all companydetails")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created companydetail")
                .get("${new_companydetail_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created companydetail")
            .delete("${new_companydetail_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
