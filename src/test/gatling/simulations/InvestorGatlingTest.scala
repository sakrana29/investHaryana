...
class InvestorGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Investor entity")
        ...
        .repeat(2) {
            ...
            .post("/api/investors")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "mouapplicable":null, "mousignyear":"0", "moudocument":null, "mouidnumber":"SAMPLE_TEXT", "photo":null, "firstname":"SAMPLE_TEXT", "middlename":"SAMPLE_TEXT", "lastname":"SAMPLE_TEXT", "countryid":null, "stateid":null, "cityid":null, "address1":"SAMPLE_TEXT", "address2":"SAMPLE_TEXT", "address3":"SAMPLE_TEXT", "emailprimary":"SAMPLE_TEXT", "emailsecondary":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
