...
/**
 * Performance test for the ProjectServiceReportInfo entity.
 */
class ProjectServiceReportInfoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ProjectServiceReportInfo entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all projectServiceReportInfos")
            .get("/api/project-service-report-infos")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created projectServiceReportInfo")
                .get("${new_projectServiceReportInfo_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created projectServiceReportInfo")
            .delete("${new_projectServiceReportInfo_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
