...
class ProjectdetailGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Projectdetail entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "projectpurpose":"SAMPLE_TEXT", "niccode":"SAMPLE_TEXT", "existing_regulatory_approval":null, "edc_sif_clu_fee_paid_applicable":null, "approval_application_form":"SAMPLE_TEXT", "category_of_project":"SAMPLE_TEXT", "collaboration_with_foreign_country":"SAMPLE_TEXT", "projectype":"SAMPLE_TEXT", "sectorname":"SAMPLE_TEXT", "size_of_industry":"SAMPLE_TEXT", "createdate":"2020-01-01T00:00:00.000Z", "updatedate":"2020-01-01T00:00:00.000Z", "sectorother":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
