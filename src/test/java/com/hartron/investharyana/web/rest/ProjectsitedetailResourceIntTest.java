...
public class ProjectsitedetailResourceIntTest extends AbstractCassandraTest {
    ...
    private static final ByteBuffer DEFAULT_KHASRA_DOCUMENT = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_KHASRA_DOCUMENT = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_KHASRA_DOCUMENT_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_KHASRA_DOCUMENT_CONTENT_TYPE = "image/png";
    ...
    private static final ByteBuffer DEFAULT_REVENU_SHAJRA_DOCUMENT = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_REVENU_SHAJRA_DOCUMENT = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_REVENU_SHAJRA_DOCUMENT_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_REVENU_SHAJRA_DOCUMENT_CONTENT_TYPE = "image/png";

    private static final ByteBuffer DEFAULT_JAMABANDI = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_JAMABANDI = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_JAMABANDI_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_JAMABANDI_CONTENT_TYPE = "image/png";

    private static final ByteBuffer DEFAULT_NONENCUMBRANCE_CERTIFICATE = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_NONENCUMBRANCE_CERTIFICATE = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_NONENCUMBRANCE_CERTIFICATE_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_NONENCUMBRANCE_CERTIFICATE_CONTENT_TYPE = "image/png";
    ...
    private static final ByteBuffer DEFAULT_SITELAYOUTPLAN = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_SITELAYOUTPLAN = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_SITELAYOUTPLAN_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_SITELAYOUTPLAN_CONTENT_TYPE = "image/png";

    private static final ByteBuffer DEFAULT_LOCATIONPLAN = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_LOCATIONPLAN = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_LOCATIONPLAN_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_LOCATIONPLAN_CONTENT_TYPE = "image/png";

    private static final ByteBuffer DEFAULT_LINEARSTRIPPLAN = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_LINEARSTRIPPLAN = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_LINEARSTRIPPLAN_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_LINEARSTRIPPLAN_CONTENT_TYPE = "image/png";
    ...
    private static final ByteBuffer DEFAULT_BUILDINGPLAN_DOCUMENT = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_BUILDINGPLAN_DOCUMENT = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_BUILDINGPLAN_DOCUMENT_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_BUILDINGPLAN_DOCUMENT_CONTENT_TYPE = "image/png";
    ...
    private static final ByteBuffer DEFAULT_CONTROLLEDAREA_DOCUMENT = ByteBuffer.wrap(TestUtil.createByteArray(1, "0"));
    private static final ByteBuffer UPDATED_CONTROLLEDAREA_DOCUMENT = ByteBuffer.wrap(TestUtil.createByteArray(2, "1"));
    private static final String DEFAULT_CONTROLLEDAREA_DOCUMENT_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_CONTROLLEDAREA_DOCUMENT_CONTENT_TYPE = "image/png";
    ...
    public static Projectsitedetail createEntity() {
        Projectsitedetail projectsitedetail = new Projectsitedetail()
                ...
                .khasra_documentContentType(DEFAULT_KHASRA_DOCUMENT_CONTENT_TYPE)
                ...
                .revenu_shajra_documentContentType(DEFAULT_REVENU_SHAJRA_DOCUMENT_CONTENT_TYPE)
                .jamabandi(DEFAULT_JAMABANDI)
                .jamabandiContentType(DEFAULT_JAMABANDI_CONTENT_TYPE)
                .nonencumbrance_certificate(DEFAULT_NONENCUMBRANCE_CERTIFICATE)
                .nonencumbrance_certificateContentType(DEFAULT_NONENCUMBRANCE_CERTIFICATE_CONTENT_TYPE)
                ...
                .sitelayoutplanContentType(DEFAULT_SITELAYOUTPLAN_CONTENT_TYPE)
                .locationplan(DEFAULT_LOCATIONPLAN)
                .locationplanContentType(DEFAULT_LOCATIONPLAN_CONTENT_TYPE)
                .linearstripplan(DEFAULT_LINEARSTRIPPLAN)
                .linearstripplanContentType(DEFAULT_LINEARSTRIPPLAN_CONTENT_TYPE)
                ...
                .buildingplan_document(DEFAULT_BUILDINGPLAN_DOCUMENT)
                .buildingplan_documentContentType(DEFAULT_BUILDINGPLAN_DOCUMENT_CONTENT_TYPE)
                ...
                .controlledarea_documentContentType(DEFAULT_CONTROLLEDAREA_DOCUMENT_CONTENT_TYPE);
    ...
    public void createProjectsitedetail() throws Exception {
        ...
        assertThat(testProjectsitedetail.getKhasra_documentContentType()).isEqualTo(DEFAULT_KHASRA_DOCUMENT_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getRevenu_shajra_documentContentType()).isEqualTo(DEFAULT_REVENU_SHAJRA_DOCUMENT_CONTENT_TYPE);
        assertThat(testProjectsitedetail.getJamabandi()).isEqualTo(DEFAULT_JAMABANDI);
        assertThat(testProjectsitedetail.getJamabandiContentType()).isEqualTo(DEFAULT_JAMABANDI_CONTENT_TYPE);
        assertThat(testProjectsitedetail.getNonencumbrance_certificate()).isEqualTo(DEFAULT_NONENCUMBRANCE_CERTIFICATE);
        assertThat(testProjectsitedetail.getNonencumbrance_certificateContentType()).isEqualTo(DEFAULT_NONENCUMBRANCE_CERTIFICATE_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getSitelayoutplanContentType()).isEqualTo(DEFAULT_SITELAYOUTPLAN_CONTENT_TYPE);
        assertThat(testProjectsitedetail.getLocationplan()).isEqualTo(DEFAULT_LOCATIONPLAN);
        assertThat(testProjectsitedetail.getLocationplanContentType()).isEqualTo(DEFAULT_LOCATIONPLAN_CONTENT_TYPE);
        assertThat(testProjectsitedetail.getLinearstripplan()).isEqualTo(DEFAULT_LINEARSTRIPPLAN);
        assertThat(testProjectsitedetail.getLinearstripplanContentType()).isEqualTo(DEFAULT_LINEARSTRIPPLAN_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getBuildingplan_document()).isEqualTo(DEFAULT_BUILDINGPLAN_DOCUMENT);
        assertThat(testProjectsitedetail.getBuildingplan_documentContentType()).isEqualTo(DEFAULT_BUILDINGPLAN_DOCUMENT_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getControlledarea_documentContentType()).isEqualTo(DEFAULT_CONTROLLEDAREA_DOCUMENT_CONTENT_TYPE);
    }
    ...
    public void getAllProjectsitedetails() throws Exception {
        ...
        restProjectsitedetailMockMvc.perform(get("/api/projectsitedetails?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].khasra_documentContentType").value(hasItem(DEFAULT_KHASRA_DOCUMENT_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].khasra_document").value(hasItem(Base64Utils.encodeToString(DEFAULT_KHASRA_DOCUMENT.array()))))
            ...
            .andExpect(jsonPath("$.[*].revenu_shajra_documentContentType").value(hasItem(DEFAULT_REVENU_SHAJRA_DOCUMENT_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].revenu_shajra_document").value(hasItem(Base64Utils.encodeToString(DEFAULT_REVENU_SHAJRA_DOCUMENT.array()))))
            .andExpect(jsonPath("$.[*].jamabandiContentType").value(hasItem(DEFAULT_JAMABANDI_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].jamabandi").value(hasItem(Base64Utils.encodeToString(DEFAULT_JAMABANDI.array()))))
            .andExpect(jsonPath("$.[*].nonencumbrance_certificateContentType").value(hasItem(DEFAULT_NONENCUMBRANCE_CERTIFICATE_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].nonencumbrance_certificate").value(hasItem(Base64Utils.encodeToString(DEFAULT_NONENCUMBRANCE_CERTIFICATE.array()))))
            ...
            .andExpect(jsonPath("$.[*].sitelayoutplanContentType").value(hasItem(DEFAULT_SITELAYOUTPLAN_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].sitelayoutplan").value(hasItem(Base64Utils.encodeToString(DEFAULT_SITELAYOUTPLAN.array()))))
            .andExpect(jsonPath("$.[*].locationplanContentType").value(hasItem(DEFAULT_LOCATIONPLAN_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].locationplan").value(hasItem(Base64Utils.encodeToString(DEFAULT_LOCATIONPLAN.array()))))
            .andExpect(jsonPath("$.[*].linearstripplanContentType").value(hasItem(DEFAULT_LINEARSTRIPPLAN_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].linearstripplan").value(hasItem(Base64Utils.encodeToString(DEFAULT_LINEARSTRIPPLAN.array()))))
            ...
            .andExpect(jsonPath("$.[*].buildingplan_documentContentType").value(hasItem(DEFAULT_BUILDINGPLAN_DOCUMENT_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].buildingplan_document").value(hasItem(Base64Utils.encodeToString(DEFAULT_BUILDINGPLAN_DOCUMENT.array()))))
            .andExpect(jsonPath("$.[*].site_situated_in_controlled_area").value(hasItem(DEFAULT_SITE_SITUATED_IN_CONTROLLED_AREA.booleanValue())))
            .andExpect(jsonPath("$.[*].controlledarea_documentContentType").value(hasItem(DEFAULT_CONTROLLEDAREA_DOCUMENT_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].controlledarea_document").value(hasItem(Base64Utils.encodeToString(DEFAULT_CONTROLLEDAREA_DOCUMENT.array()))));
    }
    ...
    public void getProjectsitedetail() throws Exception {
        ...
        restProjectsitedetailMockMvc.perform(get("/api/projectsitedetails/{id}", projectsitedetail.getId()))
            ...
            .andExpect(jsonPath("$.khasra_documentContentType").value(DEFAULT_KHASRA_DOCUMENT_CONTENT_TYPE))
            .andExpect(jsonPath("$.khasra_document").value(Base64Utils.encodeToString(DEFAULT_KHASRA_DOCUMENT.array())))
            ...
            .andExpect(jsonPath("$.revenu_shajra_documentContentType").value(DEFAULT_REVENU_SHAJRA_DOCUMENT_CONTENT_TYPE))
            .andExpect(jsonPath("$.revenu_shajra_document").value(Base64Utils.encodeToString(DEFAULT_REVENU_SHAJRA_DOCUMENT.array())))
            .andExpect(jsonPath("$.jamabandiContentType").value(DEFAULT_JAMABANDI_CONTENT_TYPE))
            .andExpect(jsonPath("$.jamabandi").value(Base64Utils.encodeToString(DEFAULT_JAMABANDI.array())))
            .andExpect(jsonPath("$.nonencumbrance_certificateContentType").value(DEFAULT_NONENCUMBRANCE_CERTIFICATE_CONTENT_TYPE))
            .andExpect(jsonPath("$.nonencumbrance_certificate").value(Base64Utils.encodeToString(DEFAULT_NONENCUMBRANCE_CERTIFICATE.array())))
            ...
            .andExpect(jsonPath("$.sitelayoutplanContentType").value(DEFAULT_SITELAYOUTPLAN_CONTENT_TYPE))
            .andExpect(jsonPath("$.sitelayoutplan").value(Base64Utils.encodeToString(DEFAULT_SITELAYOUTPLAN.array())))
            .andExpect(jsonPath("$.locationplanContentType").value(DEFAULT_LOCATIONPLAN_CONTENT_TYPE))
            .andExpect(jsonPath("$.locationplan").value(Base64Utils.encodeToString(DEFAULT_LOCATIONPLAN.array())))
            .andExpect(jsonPath("$.linearstripplanContentType").value(DEFAULT_LINEARSTRIPPLAN_CONTENT_TYPE))
            .andExpect(jsonPath("$.linearstripplan").value(Base64Utils.encodeToString(DEFAULT_LINEARSTRIPPLAN.array())))
            ...
            .andExpect(jsonPath("$.buildingplan_documentContentType").value(DEFAULT_BUILDINGPLAN_DOCUMENT_CONTENT_TYPE))
            .andExpect(jsonPath("$.buildingplan_document").value(Base64Utils.encodeToString(DEFAULT_BUILDINGPLAN_DOCUMENT.array())))
            .andExpect(jsonPath("$.site_situated_in_controlled_area").value(DEFAULT_SITE_SITUATED_IN_CONTROLLED_AREA.booleanValue()))
            .andExpect(jsonPath("$.controlledarea_documentContentType").value(DEFAULT_CONTROLLEDAREA_DOCUMENT_CONTENT_TYPE))
            .andExpect(jsonPath("$.controlledarea_document").value(Base64Utils.encodeToString(DEFAULT_CONTROLLEDAREA_DOCUMENT.array())));
    }
    ...
    public void updateProjectsitedetail() throws Exception {
        ...
        updatedProjectsitedetail
                ...
                .khasra_documentContentType(UPDATED_KHASRA_DOCUMENT_CONTENT_TYPE)
                ...
                .revenu_shajra_documentContentType(UPDATED_REVENU_SHAJRA_DOCUMENT_CONTENT_TYPE)
                .jamabandi(UPDATED_JAMABANDI)
                .jamabandiContentType(UPDATED_JAMABANDI_CONTENT_TYPE)
                .nonencumbrance_certificate(UPDATED_NONENCUMBRANCE_CERTIFICATE)
                .nonencumbrance_certificateContentType(UPDATED_NONENCUMBRANCE_CERTIFICATE_CONTENT_TYPE)
                ...
                .sitelayoutplanContentType(UPDATED_SITELAYOUTPLAN_CONTENT_TYPE)
                .locationplan(UPDATED_LOCATIONPLAN)
                .locationplanContentType(UPDATED_LOCATIONPLAN_CONTENT_TYPE)
                .linearstripplan(UPDATED_LINEARSTRIPPLAN)
                .linearstripplanContentType(UPDATED_LINEARSTRIPPLAN_CONTENT_TYPE)
                ...
                .buildingplan_document(UPDATED_BUILDINGPLAN_DOCUMENT)
                .buildingplan_documentContentType(UPDATED_BUILDINGPLAN_DOCUMENT_CONTENT_TYPE)
                ...
                .controlledarea_documentContentType(UPDATED_CONTROLLEDAREA_DOCUMENT_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getKhasra_documentContentType()).isEqualTo(UPDATED_KHASRA_DOCUMENT_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getRevenu_shajra_documentContentType()).isEqualTo(UPDATED_REVENU_SHAJRA_DOCUMENT_CONTENT_TYPE);
        assertThat(testProjectsitedetail.getJamabandi()).isEqualTo(UPDATED_JAMABANDI);
        assertThat(testProjectsitedetail.getJamabandiContentType()).isEqualTo(UPDATED_JAMABANDI_CONTENT_TYPE);
        assertThat(testProjectsitedetail.getNonencumbrance_certificate()).isEqualTo(UPDATED_NONENCUMBRANCE_CERTIFICATE);
        assertThat(testProjectsitedetail.getNonencumbrance_certificateContentType()).isEqualTo(UPDATED_NONENCUMBRANCE_CERTIFICATE_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getSitelayoutplanContentType()).isEqualTo(UPDATED_SITELAYOUTPLAN_CONTENT_TYPE);
        assertThat(testProjectsitedetail.getLocationplan()).isEqualTo(UPDATED_LOCATIONPLAN);
        assertThat(testProjectsitedetail.getLocationplanContentType()).isEqualTo(UPDATED_LOCATIONPLAN_CONTENT_TYPE);
        assertThat(testProjectsitedetail.getLinearstripplan()).isEqualTo(UPDATED_LINEARSTRIPPLAN);
        assertThat(testProjectsitedetail.getLinearstripplanContentType()).isEqualTo(UPDATED_LINEARSTRIPPLAN_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getBuildingplan_document()).isEqualTo(UPDATED_BUILDINGPLAN_DOCUMENT);
        assertThat(testProjectsitedetail.getBuildingplan_documentContentType()).isEqualTo(UPDATED_BUILDINGPLAN_DOCUMENT_CONTENT_TYPE);
        ...
        assertThat(testProjectsitedetail.getControlledarea_documentContentType()).isEqualTo(UPDATED_CONTROLLEDAREA_DOCUMENT_CONTENT_TYPE);
    }
