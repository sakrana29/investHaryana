...
public class ElectricrequirementResourceIntTest extends AbstractCassandraTest {
    ...
    public void createElectricrequirement() throws Exception {
        ...
        assertThat(testElectricrequirement.getCreatedate()).isEqualTo(DEFAULT_CREATEDATE);
        assertThat(testElectricrequirement.getUpdatedate()).isEqualTo(DEFAULT_UPDATEDATE);
    }
    ...
    public void updateElectricrequirement() throws Exception {
        ...
        assertThat(testElectricrequirement.getCreatedate()).isEqualTo(UPDATED_CREATEDATE);
        assertThat(testElectricrequirement.getUpdatedate()).isEqualTo(UPDATED_UPDATEDATE);
    }
